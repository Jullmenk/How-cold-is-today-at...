  ...
  return (
    <Container>
      <WeatherCard>
        <BlurBackground />
        <CardContent>
          <Temperature>{Math.round(Hourly.temp)}°</Temperature>
          <CenteredDiv>
            <DayAndDay>{dayName} {dayNumber}</DayAndDay>
            <FeelsLike>Feels Like: {Hourly.feelsLike.toString()}°</FeelsLike>
          </CenteredDiv>
          <ImgDiv>
              <Image
          ...
          <TempDetails>
            <TempMin>
              ...
              <TempMinValue>{Hourly.tempMin.toString()}</TempMinValue>
            </TempMin>
            <TempMax>
              <TempMaxLabel>Max</TempMaxLabel>
              <TempMaxValue>{Hourly.tempMax.toString()}</TempMaxValue>
            </TempMax>
          </TempDetails>
        </CardContent>
      </WeatherCard>
